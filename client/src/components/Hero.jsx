...
const Hero = () => {
    ...
    return (
            ...
            <div className='text-center mb-6'>
                ...
                >Create amazing content with  <br /> <span className='text-primary'> Alacritous AI Tools</span> </h1>
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-sx'>
                ...
                <button className='bg-transparent border border-gray-300 text-gray-700 px-10 py-3 rounded-lg hover:bg-gray-100 transition'>Watch demo</button>
            </div>
